...
@implementation SLSecondCommentCellV2
...
- (void)setupUI {
    ...
    self.contentLabel.textColor = Color16(0x333333);
...
- (void)updateWithComment:(SLCommentEntity *)comment authorId:(NSString *)authorId contentWidth:(CGFloat)width {
    ...
    // 设置时间
    self.timeLabel.text = [NSString smartTimeFormatWith:[comment.gmtCreate doubleValue]];
