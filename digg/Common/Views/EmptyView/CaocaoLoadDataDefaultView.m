...
- (void)resetActionButtonState {
    if (!self.largeMode) {
        ...
        self.actionButton.titleLabel.font = [UIFont systemFontOfSize:14 weight:UIFontWeightRegular];
    ...
    self.actionButton.titleLabel.font = [UIFont systemFontOfSize:20 weight:UIFontWeightRegular];
...
- (void)resetOtherButtonState {
    if (!self.largeMode) {
        ...
        self.otherButton.titleLabel.font = [UIFont systemFontOfSize:14 weight:UIFontWeightRegular];
    ...
    self.otherButton.titleLabel.font = [UIFont systemFontOfSize:20 weight:UIFontWeightRegular];
