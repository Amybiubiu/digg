...
- (void)sl_showToast:(NSString *)message duration:(NSTimeInterval)duration {
    ...
    toastContainer.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.7];
    ...
    [messageLabel.leadingAnchor constraintEqualToAnchor:toastContainer.leadingAnchor constant:16.0].active = YES;
    [messageLabel.trailingAnchor constraintEqualToAnchor:toastContainer.trailingAnchor constant:-16.0].active = YES;
    [messageLabel.topAnchor constraintEqualToAnchor:toastContainer.topAnchor constant:8.0].active = YES;
    [messageLabel.bottomAnchor constraintEqualToAnchor:toastContainer.bottomAnchor constant:-8.0].active = YES;
